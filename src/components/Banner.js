        ...
        <div className="flex flex-col gap-y-8 lg:flex-row lg:items-center lg:gap-x-12">
          ...
          <div className="flex-1 text-center font-secondary lg:text-left">
            ...
            className="flex max-w-max gap-x-6 items-center mb-12 mx-auto lg:mx-0">
              ...
              <a href="https://drive.google.com/file/d/1iH4DsCQ55N1NExG-Si0iuls8B8yOnFV-/view" target="_blank" className="flex items-center text-gradient btn-link border border-[#15b2f0] h-[55px] rounded-xl p-5">
                Download My CV
              </a>
            </motion.div>
            {/* socials */}
